...
<head>
    ...
    <title>Create Facility - Admin Panel</title>
...
<body class="bg-gray-100 min-h-screen">
    <header class="bg-slate-900 text-white shadow-lg">
        <div class="container mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-4">
            <div class="flex items-center space-x-3">
                <i class="fas fa-circle-plus text-2xl text-emerald-300"></i>
                <div>
                    <p class="text-sm uppercase tracking-widest text-slate-300">Facilities</p>
                    <h1 class="text-2xl font-bold">Add New Facility</h1>
                </div>
            </div>
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('admin.facilities.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <h2 class="text-2xl font-semibold text-gray-900">Facility Details</h2>
            ...
            <div class="flex justify-end gap-3 pt-4">
                ...
                <button type="submit" class="px-6 py-2 rounded-lg bg-emerald-600 text-white font-semibold hover:bg-emerald-700">
